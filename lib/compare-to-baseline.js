...
const COMPATIBILITY_STRONG = /(tarzi|benzer|muadil|replacement for|for use with|alternatif)/;
const COMPATIBILITY_WEAK = /(uyumlu|uygun|compatible|compatibility|destekli)/;
